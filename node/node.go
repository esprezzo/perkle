...
func (n *Node) startIPC(apis []rpc.API) error {
	...
	color.Cyan(" .----------------. .----------------. .----------------. .----------------. .----------------. .----------------. ")
	color.Cyan("| .--------------. | .--------------. | .--------------. | .--------------. | .--------------. | .--------------. |")
	color.Cyan("| |   ______     | | |  _________   | | |  _______     | | |  ___  ____   | | |   _____      | | |  _________   | |")
	color.Cyan("| |  |_   __ \\   | | | |_   ___  |  | | | |_   __ \\    | | | |_  ||_  _|  | | |  |_   _|     | | | |_   ___  |  | |")
	color.Cyan("| |    | |__) |  | | |   | |_  \\_|  | | |   | |__) |   | | |   | |_/ /    | | |    | |       | | |   | |_  \\_|  | |")
	color.Cyan("| |    |  ___/   | | |   |  _|  _   | | |   |  __ /    | | |   |  __'.    | | |    | |   _   | | |   |  _|  _   | |")
	color.Cyan("| |   _| |_      | | |  _| |___/ |  | | |  _| |  \\ \\_  | | |  _| |  \\ \\_  | | |   _| |__/ |  | | |  _| |___/ |  | |")
	color.Cyan("| |  |_____|     | | | |_________|  | | | |____| |___| | | | |____||____| | | |  |________|  | | | |_________|  | |")
	color.Cyan("| |              | | |              | | |              | | |              | | |              | | |              | |")
	color.Cyan("| '--------------' | '--------------' | '--------------' | '--------------' | '--------------' | '--------------' |")
	color.Cyan(" '----------------' '----------------' '----------------' '----------------' '----------------' '----------------' ")
