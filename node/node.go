...
func (n *Node) startIPC(apis []rpc.API) error {
	...
	color.Red(" .----------------. .----------------. .----------------. .----------------. .----------------. .----------------. ")
	color.Red("| .--------------. | .--------------. | .--------------. | .--------------. | .--------------. | .--------------. |")
	color.Red("| |   ______     | | |  _________   | | |  _______     | | |  ___  ____   | | |   _____      | | |  _________   | |")
	color.Red("| |  |_   __ \\   | | | |_   ___  |  | | | |_   __ \\    | | | |_  ||_  _|  | | |  |_   _|     | | | |_   ___  |  | |")
	color.Red("| |    | |__) |  | | |   | |_  \\_|  | | |   | |__) |   | | |   | |_/ /    | | |    | |       | | |   | |_  \\_|  | |")
	color.Red("| |    |  ___/   | | |   |  _|  _   | | |   |  __ /    | | |   |  __'.    | | |    | |   _   | | |   |  _|  _   | |")
	color.Red("| |   _| |_      | | |  _| |___/ |  | | |  _| |  \\ \\_  | | |  _| |  \\ \\_  | | |   _| |__/ |  | | |  _| |___/ |  | |")
	color.Red("| |  |_____|     | | | |_________|  | | | |____| |___| | | | |____||____| | | |  |________|  | | | |_________|  | |")
	color.Red("| |              | | |              | | |              | | |              | | |              | | |              | |")
	color.Red("| '--------------' | '--------------' | '--------------' | '--------------' | '--------------' | '--------------' |")
	color.Red(" '----------------' '----------------' '----------------' '----------------' '----------------' '----------------' ")
	return nil
